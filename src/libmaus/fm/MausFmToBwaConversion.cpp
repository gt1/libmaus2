 ...
 */
::libmaus::autoarray::AutoArray<uint64_t> libmaus::fm::MausFmToBwaConversion::loadL2T(std::string const & infn)
{
 ...
 **/
::libmaus::autoarray::AutoArray<uint64_t> libmaus::fm::MausFmToBwaConversion::loadL2(std::string const & infn)
{
 ...
 * load ISA[0]
 **/
uint64_t libmaus::fm::MausFmToBwaConversion::loadPrimary(std::string const & inisa)
{
...
void libmaus::fm::MausFmToBwaConversion::rewriteBwt(std::string const & infn, std::ostream & out)
{
	// load ISA[0]
...
void libmaus::fm::MausFmToBwaConversion::rewriteSa(std::string const & infn, std::ostream & out)
{
	std::string const inisa = ::libmaus::util::OutputFileNameTools::clipOff(infn,".bwt") + ".isa";
	uint64_t const primary = loadPrimary(inisa);
...
void libmaus::fm::MausFmToBwaConversion::rewrite(
