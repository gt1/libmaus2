...
*/
#if ! defined(LIBMAUS_LZ_BGZFDEFLATEZSTREAMBASETYPEINFO)
#define LIBMAUS_LZ_BGZFDEFLATEZSTREAMBASETYPEINFO
...
namespace libmaus
{
	namespace lz
	{
		struct BgzfDeflateZStreamBaseTypeInfo
		{
			...
			typedef libmaus::lz::BgzfDeflateZStreamBase::shared_ptr_type pointer_type;
