...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGINPUTBLOCKWORKPACKAGERETURNINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGINPUTBLOCKWORKPACKAGERETURNINTERFACE_HPP
