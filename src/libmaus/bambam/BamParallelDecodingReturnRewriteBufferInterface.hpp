...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGRETURNREWRITEBUFFERINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGRETURNREWRITEBUFFERINTERFACE_HPP
