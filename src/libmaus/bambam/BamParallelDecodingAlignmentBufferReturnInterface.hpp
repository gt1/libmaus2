...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGALIGNMENTBUFFERRETURNINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGALIGNMENTBUFFERRETURNINTERFACE_HPP
