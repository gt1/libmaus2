...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGDECOMPRESSEDPENDINGOBJECTHEAPCOMPARATOR_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGDECOMPRESSEDPENDINGOBJECTHEAPCOMPARATOR_HPP
