...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_CRAMENCODINGWORKPACKAGERETURNINTERFACE_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_CRAMENCODINGWORKPACKAGERETURNINTERFACE_HPP
