...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_DECOMPRESSEDBLOCKREORDERHEAPCOMPARATOR_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_DECOMPRESSEDBLOCKREORDERHEAPCOMPARATOR_HPP
