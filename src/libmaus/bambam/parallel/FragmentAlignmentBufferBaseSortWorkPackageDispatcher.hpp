...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_FRAGMENTALIGNMENTBUFFERBASESORTWORKPACKAGEDISPATCHER_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_FRAGMENTALIGNMENTBUFFERBASESORTWORKPACKAGEDISPATCHER_HPP

#include <libmaus/bambam/parallel/FragmentAlignmentBufferBaseSortWorkPackageReturnInterface.hpp>
...
namespace libmaus
{
	namespace bambam
	{
		namespace parallel
		{
			...
			struct FragmentAlignmentBufferBaseSortWorkPackageDispatcher : public libmaus::parallel::SimpleThreadWorkPackageDispatcher
			{
