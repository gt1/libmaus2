...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_INPUTBLOCKTYPEINFO_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_INPUTBLOCKTYPEINFO_HPP
	...
	namespace bambam
	{
		namespace parallel
		{
			struct InputBlockTypeInfo
			{
				...
				typedef libmaus::bambam::parallel::InputBlock::shared_ptr_type pointer_type;
