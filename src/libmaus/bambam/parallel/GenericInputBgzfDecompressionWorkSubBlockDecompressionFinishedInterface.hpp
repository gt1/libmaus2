...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_GENERICINPUTBGZFDECOMPRESSIONWORKSUBBLOCKDECOMPRESSIONFINISHEDINTERFACE_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_GENERICINPUTBGZFDECOMPRESSIONWORKSUBBLOCKDECOMPRESSIONFINISHEDINTERFACE_HPP
