...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGPARSEDBLOCKADDPENDINGINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGPARSEDBLOCKADDPENDINGINTERFACE_HPP
