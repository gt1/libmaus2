...
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGDECOMPRESSBLOCKWORKPACKAGERETURNINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGDECOMPRESSBLOCKWORKPACKAGERETURNINTERFACE_HPP
