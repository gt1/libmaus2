...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGVALIDATEBLOCKADDPENDINGINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGVALIDATEBLOCKADDPENDINGINTERFACE_HPP
