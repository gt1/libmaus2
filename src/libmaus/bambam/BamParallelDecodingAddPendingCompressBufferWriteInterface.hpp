...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGADDPENDINGCOMPRESSBUFFERWRITEINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGADDPENDINGCOMPRESSBUFFERWRITEINTERFACE_HPP
