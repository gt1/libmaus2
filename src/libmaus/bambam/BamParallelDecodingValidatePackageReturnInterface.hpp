...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGVALIDATEPACKAGERETURNINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGVALIDATEPACKAGERETURNINTERFACE_HPP
