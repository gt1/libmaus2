...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGRETURNCOMPRESSIONPENDINGELEMENTINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGRETURNCOMPRESSIONPENDINGELEMENTINTERFACE_HPP
