...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGINPUTBLOCKADDPENDINGINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGINPUTBLOCKADDPENDINGINTERFACE_HPP
