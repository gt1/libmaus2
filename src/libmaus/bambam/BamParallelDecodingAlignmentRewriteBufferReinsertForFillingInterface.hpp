...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGALIGNMENTREWRITEBUFFERREINSERTFORFILLINGINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGALIGNMENTREWRITEBUFFERREINSERTFORFILLINGINTERFACE_HPP
