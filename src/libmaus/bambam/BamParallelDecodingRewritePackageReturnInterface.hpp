...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGREWRITEPACKAGERETURNINTERFACE_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGREWRITEPACKAGERETURNINTERFACE_HPP
