...
*/
#if ! defined(LIBMAUS_BAMBAM_BAMPARALLELDECODINGCOMPRESSBUFFERHEAPCOMPARATOR_HPP)
#define LIBMAUS_BAMBAM_BAMPARALLELDECODINGCOMPRESSBUFFERHEAPCOMPARATOR_HPP
