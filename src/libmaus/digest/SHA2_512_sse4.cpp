...
void libmaus::digest::SHA2_512_sse4::update(uint8_t const * t, size_t l)
{
...
void libmaus::digest::SHA2_512_sse4::digest(uint8_t * digest)
{
...
void libmaus::digest::SHA2_512_sse4::copyFrom(SHA2_512_sse4 const & O)
{
