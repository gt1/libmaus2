...
namespace libmaus
{
	namespace bitio
	{
		...
		struct CheckedBitWriterTemplate
		{
			public:
			/**
		...
		typedef CheckedBitWriterTemplate<uint8_t,   uint8_t *,              0x80    > CheckedBitWriter;
		typedef CheckedBitWriterTemplate<uint16_t, uint16_t *,            0x8000    > CheckedBitWriter2;
		typedef CheckedBitWriterTemplate<uint32_t, uint32_t *,        0x80000000    > CheckedBitWriter4;
		typedef CheckedBitWriterTemplate<uint64_t, uint64_t *, 0x8000000000000000ULL> CheckedBitWriter8;
		typedef CheckedBitWriterTemplate<uint8_t , std::back_insert_iterator< std::vector<uint8_t> >, 0x80> CheckedBitWriterVector8;
		typedef CheckedBitWriterTemplate<uint64_t , std::back_insert_iterator< std::vector<uint64_t> >, 0x8000000000000000ULL> CheckedBitWriterVector64;
		typedef CheckedBitWriterTemplate<uint8_t , std::ostream_iterator < uint8_t >, 0x80 > CheckedBitWriterStream8;
	}
}
#endif
