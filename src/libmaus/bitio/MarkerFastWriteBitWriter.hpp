...
#include <libmaus/aio/SynchronousGenericOutputPosix.hpp>
...
namespace libmaus
{
	namespace bitio
	{
		...
		struct MarkerFastWriteBitWriterTemplate
		{
			...
			void write(N n, unsigned int b)
			{
				...
				else
				{
					...
					b -= bitsleft;
					writeCurrent();
					write<N>(n & ::libmaus::math::lowbits(b) , b);					
				}
			}
		...
		typedef MarkerFastWriteBitWriterTemplate<uint8_t , ::libmaus::aio::SynchronousGenericOutputPosix<uint8_t>::iterator_type, 0x80, 0xFF > MarkerFastWriteBitWriterStream8Posix;
		typedef MarkerFastWriteBitWriterTemplate<uint8_t , ::libmaus::aio::SynchronousGenericOutput<uint8_t>::iterator_type, 0x80, 0xFF > MarkerFastWriteBitWriterStream8Std;
		typedef MarkerFastWriteBitWriterTemplate<uint64_t , ::libmaus::aio::SynchronousGenericOutputPosix<uint64_t>::iterator_type, 0x8000000000000000ULL, 0xFFFFFFFFFFFFFFFFULL> MarkerFastWriteBitWriterBuffer64PosixSync;
		typedef MarkerFastWriteBitWriterTemplate<uint64_t , ::libmaus::aio::SynchronousGenericOutput<uint64_t>::iterator_type, 0x8000000000000000ULL, 0xFFFFFFFFFFFFFFFFULL> MarkerFastWriteBitWriterBuffer64Sync;
		typedef MarkerFastWriteBitWriterTemplate<uint32_t , ::libmaus::aio::SynchronousGenericOutputPosix<uint32_t>::iterator_type, 0x80000000ULL, 0xFFFFFFFFULL> MarkerFastWriteBitWriterBuffer32PosixSync;
		typedef MarkerFastWriteBitWriterTemplate<uint32_t , ::libmaus::aio::SynchronousGenericOutput<uint32_t>::iterator_type, 0x80000000ULL, 0xFFFFFFFFULL> MarkerFastWriteBitWriterBuffer32Sync;
	}
}
#endif
