...
*/
#if ! defined(LIBMAUS2_UTIL_ALPHADIGITTABLE_HPP)
#define LIBMAUS2_UTIL_ALPHADIGITTABLE_HPP
...
namespace libmaus2
{
	namespace util
	{
		 ...
		 * is such that A[i] == true iff isalnum(i)== true for
		 * 0 <= i < 256
		 **/
		struct AlphaDigitTable
		{
			//! digit table
			char A[256];
