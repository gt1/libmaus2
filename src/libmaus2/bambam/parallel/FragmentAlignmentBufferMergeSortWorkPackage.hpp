...
*/
#if ! defined(LIBMAUS2_BAMBAM_PARALLEL_FRAGMENTALIGNMENTBUFFERMERGESORTWORKPACKAGE_HPP)
#define LIBMAUS2_BAMBAM_PARALLEL_FRAGMENTALIGNMENTBUFFERMERGESORTWORKPACKAGE_HPP
...
namespace libmaus2
{
	namespace bambam
	{
		namespace parallel
		{
			...
			struct FragmentAlignmentBufferMergeSortWorkPackage : public libmaus2::parallel::SimpleThreadWorkPackage
			{
				...
				FragmentAlignmentBufferMergeSortWorkPackage() : libmaus2::parallel::SimpleThreadWorkPackage(), request(0) {}
