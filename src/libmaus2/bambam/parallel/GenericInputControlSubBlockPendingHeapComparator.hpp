...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_GENERICINPUTCONTROLSUBBLOCKPENDINGHEAPCOMPARATOR_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_GENERICINPUTCONTROLSUBBLOCKPENDINGHEAPCOMPARATOR_HPP
