...
*/
#if ! defined(LIBMAUS2_BAMBAM_PARALLEL_ALIGNMENTREWRITEPOSMERGESORTPACKAGE_HPP)
#define LIBMAUS2_BAMBAM_PARALLEL_ALIGNMENTREWRITEPOSMERGESORTPACKAGE_HPP
...
namespace libmaus2
{
	namespace bambam
	{
		namespace parallel
		{
			...
			struct AlignmentRewritePosMergeSortPackage : public libmaus2::parallel::SimpleThreadWorkPackage
			{
