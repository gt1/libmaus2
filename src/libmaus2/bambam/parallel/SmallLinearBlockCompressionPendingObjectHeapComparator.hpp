...
*/
#if ! defined(LIBMAUS2_BAMBAM_PARALLEL_SMALLLINEARBLOCKCOMPRESSIONPENDINGOBJECTHEAPCOMPARATOR_HPP)
#define LIBMAUS2_BAMBAM_PARALLEL_SMALLLINEARBLOCKCOMPRESSIONPENDINGOBJECTHEAPCOMPARATOR_HPP
