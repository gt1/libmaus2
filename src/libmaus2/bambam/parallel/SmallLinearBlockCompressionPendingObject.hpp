...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_SMALLLINEARBLOCKCOMPRESSIONPENDINGOBJECT_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_SMALLLINEARBLOCKCOMPRESSIONPENDINGOBJECT_HPP
