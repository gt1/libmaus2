...
*/
#if ! defined(LIBMAUS2_BAMBAM_PARALLEL_DECOMPRESSEDBLOCKTYPEINFO_HPP)
#define LIBMAUS2_BAMBAM_PARALLEL_DECOMPRESSEDBLOCKTYPEINFO_HPP
	...
	namespace bambam
	{
		namespace parallel
		{
			struct DecompressedBlockTypeInfo
			{
				...
				typedef libmaus2::bambam::parallel::DecompressedBlock::shared_ptr_type pointer_type;
