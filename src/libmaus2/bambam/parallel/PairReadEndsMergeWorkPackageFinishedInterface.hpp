...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_PAIRREADENDSMERGEWORKPACKAGEFINISHEDINTERFACE_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_PAIRREADENDSMERGEWORKPACKAGEFINISHEDINTERFACE_HPP
