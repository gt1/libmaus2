...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_CRAMOUTPUTBLOCKCHECKSUMPACKAGEINTERFACE_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_CRAMOUTPUTBLOCKCHECKSUMPACKAGEINTERFACE_HPP
