...
*/
#if ! defined(LIBMAUS2_BAMBAM_PARALLEL_FRAGMENTALIGNMENTBUFFERTYPEINFO_HPP)
#define LIBMAUS2_BAMBAM_PARALLEL_FRAGMENTALIGNMENTBUFFERTYPEINFO_HPP
	...
	namespace bambam
	{
		namespace parallel
		{
			struct FragmentAlignmentBufferTypeInfo
			{
				...
				typedef libmaus2::bambam::parallel::FragmentAlignmentBuffer::shared_ptr_type pointer_type;
