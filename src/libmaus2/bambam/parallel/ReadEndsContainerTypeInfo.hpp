...
*/
#if ! defined(LIBMAUS2_BAMBAM_PARALLEL_READENDSCONTAINERTYPEINFO_HPP)
#define LIBMAUS2_BAMBAM_PARALLEL_READENDSCONTAINERTYPEINFO_HPP
...
namespace libmaus2
{
	namespace bambam
	{
		namespace parallel
		{
			struct ReadEndsContainerTypeInfo
			{
