...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_SAMENCODINGWORKPACKAGEWRAPPERRETURNINTERFACE_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_SAMENCODINGWORKPACKAGEWRAPPERRETURNINTERFACE_HPP
