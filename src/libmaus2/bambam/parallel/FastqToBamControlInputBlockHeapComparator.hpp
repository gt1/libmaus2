...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_FASTQTOBAMCONTROLINPUTBLOCKHEAPCOMPARATOR_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_FASTQTOBAMCONTROLINPUTBLOCKHEAPCOMPARATOR_HPP
