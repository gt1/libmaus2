...
*/
#if ! defined(LIBMAUS_BAMBAM_PARALLEL_GENERICINPUTCONTROLCOMPRESSIONPENDINGHEAPCOMPARATOR_HPP)
#define LIBMAUS_BAMBAM_PARALLEL_GENERICINPUTCONTROLCOMPRESSIONPENDINGHEAPCOMPARATOR_HPP
