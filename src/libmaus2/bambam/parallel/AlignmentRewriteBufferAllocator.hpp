...
*/
#if ! defined(LIBMAUS2_BAMBAM_PARALLEL_ALIGNMENTREWRITEBUFFERALLOCATOR_HPP)
#define LIBMAUS2_BAMBAM_PARALLEL_ALIGNMENTREWRITEBUFFERALLOCATOR_HPP
...
namespace libmaus2
{
	namespace bambam
	{
		namespace parallel
		{
			struct AlignmentRewriteBufferAllocator
			{
				uint64_t bufferSize;
				uint64_t mult;
