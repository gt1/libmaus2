...
*/
#if ! defined(LIBMAUS2_BAMBAM_PARALLEL_FASTQPARSEPACKAGE_HPP)
#define LIBMAUS2_BAMBAM_PARALLEL_FASTQPARSEPACKAGE_HPP
...
namespace libmaus2
{
	namespace bambam
	{
		namespace parallel
		{
			struct FastqParsePackage : public libmaus2::parallel::SimpleThreadWorkPackage
			{
				...
				FastqParsePackage() : libmaus2::parallel::SimpleThreadWorkPackage(), data()
				{				
				}		
