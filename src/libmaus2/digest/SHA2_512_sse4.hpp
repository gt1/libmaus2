...
*/
#if ! defined(LIBMAUS2_DIGEST_SHA2_512_SSE4_HPP)
#define LIBMAUS2_DIGEST_SHA2_512_SSE4_HPP
...
namespace libmaus2
{
	namespace digest
	{
		struct SHA2_512_sse4 : public DigestBase<64,7 /* block size 64 shift */, true /* need padding */, 16 /* number length */, true>
		{
			typedef DigestBase<64,7 /* block size 64 shift */, true /* need padding */, 16 /* number length */, true> base_type;
			...
			void copyFrom(SHA2_512_sse4 const & O);
