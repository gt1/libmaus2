...
*/
#if ! defined(LIBMAUS2_DIGEST_DIGESTFACTORY_CRC32_SSE42_HPP)
#define LIBMAUS2_DIGEST_DIGESTFACTORY_CRC32_SSE42_HPP
...
namespace libmaus2
{
	namespace digest
	{
		struct DigestFactory_CRC32C_SSE42 : DigestFactoryInterface
		{
			...
			{
				DigestFactoryInterface::shared_ptr_type ptr(new DigestFactory_CRC32C_SSE42);
				return ptr;
			}
		};
	}
