...
*/
#if !defined(LIBMAUS2_AIO_MEMORYINPUTSTREAMBUFFER_HPP)
#define LIBMAUS2_AIO_MEMORYINPUTSTREAMBUFFER_HPP
...
namespace libmaus2
{
	namespace aio
	{
		struct MemoryInputStreamBuffer : public ::std::streambuf
		{
			public:
			...
			MemoryInputStreamBuffer(MemoryInputStreamBuffer const &);
			MemoryInputStreamBuffer & operator=(MemoryInputStreamBuffer &);
