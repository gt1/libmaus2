...
*/
#if ! defined(LIBMAUS2_AIO_POSIXFDINPUTOUTPUTSTREAM_HPP)
#define LIBMAUS2_AIO_POSIXFDINPUTOUTPUTSTREAM_HPP

#include <libmaus2/aio/PosixFdInputOutputStreamBuffer.hpp>

namespace libmaus2
{
	namespace aio
	{
		struct PosixFdInputOutputStream : public PosixFdInputOutputStreamBuffer, public std::iostream
		{
