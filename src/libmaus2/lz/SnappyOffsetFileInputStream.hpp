...
*/
#if ! defined(LIBMAUS_LZ_SNAPPYOFFSETFILEINPUTSTREAM_HPP)
#define LIBMAUS_LZ_SNAPPYOFFSETFILEINPUTSTREAM_HPP
...
namespace libmaus2
{
	namespace lz
	{
		struct SnappyOffsetFileInputStream
		{
			...
			typedef libmaus2::aio::CheckedInputStream stream_type;
