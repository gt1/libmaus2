							...
							if ((curd+1)<=d)
							{
								...
								if ( na != pa )
								{
									...
									if ( nb != pb )
									{
										...
										{
											QueueElement qel(pa,pb+1,mat,mis,ins+1,del,(evec<<1)|1);
											Q.push_back(qel);
										...
										{
											QueueElement qel(pa+1,pb,mat,mis,ins,del+1,(evec<<1)|1);
											Q.push_back(qel);
										...
										{
											QueueElement qel(pa+1,pb+1,mat,mis+1,ins,del,(evec<<1)|1);
											Q.push_back(qel);
