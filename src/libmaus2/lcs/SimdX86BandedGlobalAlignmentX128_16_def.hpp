...
*/
#define LIBMAUS2_LCS_SIMD_BANDED_CLASS_NAME SimdX86BandedGlobalAlignmentX128_16
#define LIBMAUS2_LCS_SIMD_BANDED_WORD_TYPE __m128i
#define LIBMAUS2_LCS_SIMD_BANDED_ELEMENT_TYPE uint16_t
#define LIBMAUS2_LCS_SIMD_BANDED_FIRST_FF_REST_0 libmaus2::lcs::SimdX86GlobalAlignmentConstants128::xmm_16_banded_first_ff_rest_0
#define LIBMAUS2_LCS_SIMD_BANDED_LAST_FF_REST_0 libmaus2::lcs::SimdX86GlobalAlignmentConstants128::xmm_16_banded_last_ff_rest_0
#define LIBMAUS2_LCS_SIMD_BANDED_ALL_ONE libmaus2::lcs::SimdX86GlobalAlignmentConstants128::xmm_16_banded_all_one
#define LIBMAUS2_LCS_SIMD_BANDED_SELECT_FIRST_TOBACK libmaus2::lcs::SimdX86GlobalAlignmentConstants128::xmm_16_banded_select_first_to_back
...
#define LIBMAUS2_LCS_SIMD_BANDED_CMPEQ _mm_cmpeq_epi16
#define LIBMAUS2_LCS_SIMD_BANDED_ADD _mm_adds_epu16
#define LIBMAUS2_LCS_SIMD_BANDED_SHUFFLE _mm_shuffle_epi8
#define LIBMAUS2_LCS_SIMD_BANDED_MIN _mm_min_epu16

#define LIBMAUS2_LCS_SIMD_BANDED_SHIFT_RIGHT libmaus2::lcs::SimdX86GlobalAlignmentConstants128::xmm_16_banded_shift_right
#define LIBMAUS2_LCS_SIMD_BANDED_SELECT_LAST libmaus2::lcs::SimdX86GlobalAlignmentConstants128::xmm_16_banded_select_last
#define LIBMAUS2_LCS_SIMD_BANDED_SHIFT_LEFT libmaus2::lcs::SimdX86GlobalAlignmentConstants128::xmm_16_banded_shift_left
