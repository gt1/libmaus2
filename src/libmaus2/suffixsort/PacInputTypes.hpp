...
**/
#if ! defined(LIBMAUS2_SUFFIXSORT_PACINPUTTYPES_HPP)
...
namespace libmaus2
{
	...
	{
		struct PacInputTypes : public libmaus2::suffixsort::BwtMergeEnumBase
		{
			typedef ::std::istream base_input_stream;
			typedef ::libmaus2::bitio::PacDecoderWrapper linear_wrapper;
			typedef ::libmaus2::aio::PacCircularWrapper circular_wrapper;
			typedef ::libmaus2::aio::PacCircularReverseWrapper circular_reverse_wrapper;
