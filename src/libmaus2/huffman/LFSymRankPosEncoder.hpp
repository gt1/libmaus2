...
*/
#if ! defined(LIBMAUS2_GAMMA_LFSYMRANKPOSENCODER_HPP)
#define LIBMAUS2_GAMMA_LFSYMRANKPOSENCODER_HPP
...
namespace libmaus2
{
	namespace huffman
	{
		struct LFSymRankPosEncoder
		{
			typedef LFSymRankPosEncoder this_type;
			...
			LFSymRankPos * const pa;
			LFSymRankPos * pc;
			LFSymRankPos * const pe;
			...
			LFSymRankPosEncoder(std::string const & rfn, uint64_t const blocksize = 4096)
			...
			void encode(LFSymRankPos const & L)
			{
				*pc = L;
