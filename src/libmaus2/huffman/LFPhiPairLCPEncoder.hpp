...
*/
#if ! defined(LIBMAUS2_GAMMA_LFPHIPAIRLCPENCODER_HPP)
#define LIBMAUS2_GAMMA_LFPHIPAIRLCPENCODER_HPP
...
namespace libmaus2
{
	namespace huffman
	{
		struct LFPhiPairLCPEncoder
		{
			typedef LFPhiPairLCPEncoder this_type;
			...
			LFPhiPairLCP * const pa;
			LFPhiPairLCP * pc;
			LFPhiPairLCP * const pe;
			...
			LFPhiPairLCPEncoder(std::string const & rfn, uint64_t const blocksize = 4096)
			...
			void encode(LFPhiPairLCP const & L)
			{
				*pc++ = L;
			...
			struct R1Projector { static uint64_t project(LFPhiPairLCP const & P) { return P.r1; } };
			struct P1Projector { static uint64_t project(LFPhiPairLCP const & P) { return P.p1; } };
			struct LCPProjector { static uint64_t project(LFPhiPairLCP const & P) { return P.lcp; } };
