...
*/
#if ! defined(LIBMAUS2_GAMMA_LFPHIPAIRENCODER_HPP)
#define LIBMAUS2_GAMMA_LFPHIPAIRENCODER_HPP
...
namespace libmaus2
{
	namespace huffman
	{
		struct LFPhiPairEncoder
		{
			typedef LFPhiPairEncoder this_type;
			...
			LFPhiPairEncoder(std::string const & rfn, uint64_t const blocksize = 4096)
