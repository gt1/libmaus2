...
*/
#if ! defined(LIBMAUS2_FASTX_COORDINATECACHEBIDIR_HPP)
#define LIBMAUS2_FASTX_COORDINATECACHEBIDIR_HPP
...
namespace libmaus2
{
	namespace fastx
	{
		struct CoordinateCacheBiDir
		{
			typedef CoordinateCacheBiDir this_type;
			typedef libmaus2::util::unique_ptr<this_type>::type unique_ptr_type;

			unsigned int const blockshift;
			uint64_t const n;
			libmaus2::fastx::DNAIndexMetaDataBigBandBiDir const & index;
			uint64_t const blocksize;
			uint64_t const numblocks;
			libmaus2::autoarray::AutoArray<int64_t> C;

			CoordinateCacheBiDir(libmaus2::rank::DNARank const & rrank, libmaus2::fastx::DNAIndexMetaDataBigBandBiDir const & rindex, unsigned int const rblockshift = 16)
