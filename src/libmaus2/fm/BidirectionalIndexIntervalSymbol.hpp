...
*/
#if ! defined(LIBMAUS2_SUFFIXSORT_BIDIRECTIONALINDEXINTERVALSYMBOL_HPP)
#define LIBMAUS2_SUFFIXSORT_BIDIRECTIONALINDEXINTERVALSYMBOL_HPP
...
namespace libmaus2
{
	namespace fm
	{
		...
		std::ostream & operator<<(std::ostream & out, BidirectionalIndexIntervalSymbol const & BI);
	}
}
#endif
